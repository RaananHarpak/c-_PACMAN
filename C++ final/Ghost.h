...
public:
	...
	bool move(char ghost1nextchar,char ghost1curchar,bool IfMenuIsFirst,char level,int rowBoard,int colBoard,fstream& outputfile,string obj,bool withFiles,int& caseOpt);
